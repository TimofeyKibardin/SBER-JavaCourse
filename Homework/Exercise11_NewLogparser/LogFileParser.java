...
public class LogFileParser {
    ...
    static class LogParser implements LogQuery {
        ...
        public Set<String> getIPsForUser(String user, Date after, Date before) {
            ...
            for (String line : getLines(logDir, after, before)) {
                ...
                String tempUser = line.substring(0, line.length()).replaceAll("\\W\\d\\w", "")
                        .trim();

                String usernameFromLog = tempUser.split("\t")[1]
                        .replaceAll("\\d", "")
                        .trim();
